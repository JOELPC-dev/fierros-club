...
export default function Footer({ scrollTo }) {
  ...
  return (
    <footer className="w-full bg-zinc-950 py-16 border-t border-zinc-900">
      ...
      {/* --- REDES SOCIALES Y WHATSAPP FLOTANTES --- */}
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        {/* Instagram Flotante */}
        <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noreferrer" 
          className="bg-[#E1306C] p-3 rounded-lg shadow-xl hover:scale-110 transition-transform flex items-center justify-center text-white">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.77 1.683 4.918 4.918.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.148 3.252-1.683 4.77-4.918 4.918-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.77-1.683-4.918-4.918-.058-1.266-.07-1.646-.07-4.85s.012-3.584.07-4.85c.148-3.252 1.683-4.77 4.918-4.918 1.266-.058 1.646-.07 4.85-.07zm0 2.163c-3.13 0-3.511.012-4.747.068-2.612.119-3.766 1.488-3.885 3.885-.056 1.236-.068 1.617-.068 4.747s.012 3.511.068 4.747c.119 2.612 1.488 3.766 3.885 3.885 1.236.056 1.617.068 4.747.068s3.511-.012 4.747-.068c2.612-.119 3.766-1.488 3.885-3.885.056-1.236.068-1.617.068-4.747s-.012-3.511-.068-4.747c-.119-2.612-1.488-3.766-3.885-3.885-1.236-.056-1.617-.068-4.747-.068zm0 3.754c3.447 0 6.244 2.797 6.244 6.244s-2.797 6.244-6.244 6.244-6.244-2.797-6.244-6.244 2.797-6.244 6.244-6.244zm0 1.936c-2.368 0-4.288 1.92-4.288 4.288s1.92 4.288 4.288 4.288 4.288-1.92 4.288-4.288-1.92-4.288-4.288-4.288zm5.127-1.336c0 .805-.653 1.458-1.458 1.458s-1.458-.653-1.458-1.458.653-1.458 1.458-1.458 1.458.653 1.458 1.458z"/></svg>
        </a>

        {/* Facebook Flotante */}
        <a href={SOCIAL_LINKS.facebook} target="_blank" rel="noreferrer" 
          className="bg-[#1877F2] p-3 rounded-lg shadow-xl hover:scale-110 transition-transform flex items-center justify-center text-white">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
        </a>

        {/* TikTok Flotante */}
        <a href={SOCIAL_LINKS.tiktok} target="_blank" rel="noreferrer" 
          className="bg-black p-3 rounded-lg shadow-xl hover:scale-110 transition-transform flex items-center justify-center text-white border border-zinc-800">
